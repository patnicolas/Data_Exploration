...
class PlotterMixin(object):
    ...
    def single_plot_np_array(np_array1: np.array, np_array2: np.array, plotter_parameters: PlotterParameters):
        ...
        axes.grid()
        fig.savefig(f"{PlotterParameters.images_folder}/plot-{plotter_parameters.time_str}.png")
        plt.show()
    ...
    def two_plot(values1: list, values2: list, plotter_parameters_list: list):
        ...
        axes[1].grid()
        fig.savefig(f"{PlotterParameters.images_folder}/plot-{PlotterMixin.timestr()}.png")
        plt.show()
